...
<footer>
    <div class="contain">
        <div class="flex">
            <div class="col">
                <h5>About Company</h5>
                <p>{{$site_settings->site_about_company}}</p>
            </div>
            <div class="col">
                <h5>Contact Info</h5>
                <ul class="lst">
                    <li><a href="mailto:Info@morplastics.com">{{$site_settings->site_email}}</a></li>
                    <li><a href="tel:516-816-5251">{{$site_settings->site_phone}}</a></li>
                    <li><a href="">{{$site_settings->site_address}}</a></li>
                </ul>
                <div class="br"></div>
                <h5>Follow us on</h5>
                <ul class="social_lnks">
            ...
            <div class="col">
                ...
                <form id="newsletterForm" action="{{url('/api/save-newsletter')}}" method="post" autocomplete="off"
                    class="frmAjax">
                    <label for="email">{{$site_settings->site_newsletter_text}}</label>
                    <div class="txtGrp relative">
                        <input type="email" name="email" id="email" class="input" placeholder="@ your email address"
                            required>
                        <button type="submit" class="site_btn">Submit<i class="spinner hidden"></i></button>
    ...
    <div class="copy_right">
        <div class="contain">
            <div class="_inner">
                <p>©{{date('Y')}} <a href="{{url('/')}}">{{$site_settings->site_name}}</a>.
                    {{$site_settings->site_copyright}}</p>
