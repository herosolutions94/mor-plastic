        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <?php $section1 = 0; ?>
                        @for ($i = 2; $i <= 4; $i++) <?php $section1 = $section1 + 1; ?> <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col">
                                            <div class="mb-4">
                                                <label class="form-label" for="sec1_heading{{ $i }}">Heading
                                                    {{ $section1 }}</label>
                                                <input class="form-control" id="sec1_heading{{ $i }}" type="text"
                                    ...
                                    <div class="col">
                                        <div class="mb-4">
                                            <label class="form-label" for="sec1_heading{{ $i }}">Text
                                                {{ $section1 }}</label>

                                            <textarea class="form-control" id="sec1_text{{ $i }}" type="text"
                                                name="sec1_text{{ $i }}">{{ !empty($sitecontent['sec1_text' . $i]) ? $sitecontent['sec1_text' . $i] : '' }}</textarea>
                                        </div>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label" for="section4_heading1">Heading 1</label>
                                <input class="form-control" id="section4_heading1" type="text" name="section4_heading1"
                                    placeholder="" value="{{ $sitecontent['section4_heading1'] ?? '' }}">
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label" for="section4_text1">Text 1</label>
                                <textarea id="section4_text1" name="section4_text1" rows="4"
                                    class="form-control">{{ !empty($sitecontent['section4_text1']) ? $sitecontent['section4_text1'] : '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label" for="section4_heading2">Heading 2</label>
                                <input class="form-control" id="section4_heading2" type="text" name="section4_heading2"
                                    placeholder="" value="{{ $sitecontent['section4_heading2'] ?? '' }}">
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label" for="section4_text2">Text 2</label>
                                <textarea id="section4_text2" name="section4_text2" rows="4"
                                    class="form-control">{{ !empty($sitecontent['section4_text2']) ? $sitecontent['section4_text2'] : '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="section5_sub_heading" type="text"
                                    name="section5_sub_heading" placeholder=""
                                    value="{{ $sitecontent['section5_sub_heading'] ?? '' }}">
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label" for="section6_sub_heading">Sub Heading</label>
                                <input id="section6_sub_heading" type="text" name="section6_sub_heading"
                                    class=" form-control" placeholder=""
                                    value="{{ !empty($sitecontent['section6_sub_heading']) ? $sitecontent['section6_sub_heading'] : '' }}">
                            </div>
                            <div class=" mb-3">
